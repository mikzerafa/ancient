...
export class JsonParser {
    ...
    private _entities: ArrayEvolve<number, Entity>;

    constructor() {
        this._entities = new ArrayEvolve<number, Entity>();
    }

    FindAncestorKey(parentEntity: Entity) {
        return parentEntity.key;
    }

    ParseLayer(json: string, level: number = 0, parentEntity?: Entity, parentIndex?: number) {
        ...
        do {
            ...
            if (sm.FirstCharIgnoringSpacesIs(content, "[")) {
                ...
                if (arrayValues.includes(',')) {
                    ...
                    values = new Map<number, string>().set(0, arrayValues);
                }
            ...
            if (isArray) {
                ...
                entity = new Entity(key, "", level, parentEntity, parentIndex, values)
